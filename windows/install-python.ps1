...
Download-URL 'https://www.python.org/ftp/python/3.6.0/python-3.6.0-amd64.exe' $downloadDir
Download-URL 'https://www.python.org/ftp/python/3.6.0/python-3.6.0.exe' $downloadDir

Install-Python 'python-3.6.0-amd64.exe' $downloadDir 'C:\\Python36-x64'
Install-Python 'python-3.6.0.exe' $downloadDir 'C:\\Python36-x86'
