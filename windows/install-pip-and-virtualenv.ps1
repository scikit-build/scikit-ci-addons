...
Install-Pip 'C:\\Python36-x86' $downloadDir
Install-Pip 'C:\\Python36-x64' $downloadDir
...
Pip-Install 'C:\\Python36-x86' 'virtualenv'
Pip-Install 'C:\\Python36-x64' 'virtualenv'
